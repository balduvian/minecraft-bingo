...
class GenerateBoardsCommand : BasicCommand {
	override fun execute(commandSourceStack: CommandSourceStack, args: Array<String>) {
		val sender = Commands.getSenderPlayer(commandSourceStack, true) ?: return
...
class OpenBoardCommand : BasicCommand {
	override fun suggest(commandSourceStack: CommandSourceStack, args: Array<String>) = Commands.suggestPlayers(args)

	override fun execute(commandSourceStack: CommandSourceStack, args: Array<String>) {
		val sender = Commands.getSenderPlayer(commandSourceStack) ?: return
...
class StartGameCommand : BasicCommand {
	...
	override fun execute(commandSourceStack: CommandSourceStack, args: Array<String>) {
		val sender = Commands.getOpSender(commandSourceStack) ?: return
...
class EndGameCommend : BasicCommand {
	override fun execute(commandSourceStack: CommandSourceStack, args: Array<String>) {
		...
		if (Game.ongoingGame == null) return sender.sendMessage("game already going")
...
class SpectateCommand : BasicCommand {
	override fun execute(commandSourceStack: CommandSourceStack, args: Array<String>) {
		val player = Commands.getSenderPlayer(commandSourceStack) ?: return
